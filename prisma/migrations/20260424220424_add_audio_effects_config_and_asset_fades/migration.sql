...
-- CreateTable
CREATE TABLE "AudioEffectsConfig" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "profileId" TEXT NOT NULL,
    "crossfadeEnabled" BOOLEAN NOT NULL DEFAULT false,
    "crossfadeMs" INTEGER NOT NULL DEFAULT 2000,
    "crossfadeCurve" TEXT NOT NULL DEFAULT 'equal-power',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "AudioEffectsConfig_profileId_fkey" FOREIGN KEY ("profileId") REFERENCES "Profile" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "AudioEffectsConfig_profileId_key" ON "AudioEffectsConfig"("profileId");
